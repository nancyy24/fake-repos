            ...
            <div className=" d-flex justify-content-center my-2 mb-5">
                    <div className=" col-12 col-sm-3 p-sm-2 mb-2 ">
                        <div className="set-location me-3">
                            ...
                            <select className=" form-control p-3 p-sm-2 " onChange={(event)=>{getLocationId(event)} }>
                    ...
                    <div className=" col-12 col-sm-3 p-2">
                        ...
                        {restList.length !== 0 ? (restList.map((rest,index) => { return ( <ul className="set-location-list  small" key={"index"}>
                            <li className="set-bottom p-2" onClick= {()=> navigate("/restaurant/"+rest._id)}>
